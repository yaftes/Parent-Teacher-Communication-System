        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassRollNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ActiveParticipation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HavingFun = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Formality = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Meal = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Parentfollowup = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Handwriting = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Readingskill = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Materialhandling = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TeacherComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ParentComment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPerformanceReport", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentPerformanceReport_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassTeacher_AspNetUsers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Lessonoftheday = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    classWorkonExBook = table.Column<bool>(type: "bit", nullable: true),
                    classWorkonTextBookPage = table.Column<int>(type: "int", nullable: false),
                    HomeWorkonExBook = table.Column<bool>(type: "bit", nullable: true),
                    HomeWorkonTextBookPage = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseReport_Course_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Course",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentPerformanceReport_StudentId",
                table: "StudentPerformanceReport",
                column: "StudentId");
        }
